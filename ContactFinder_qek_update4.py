...
epatterns.append(r'([A-Za-z._0-9]+)\s*(?:@|\sat\s)\s*([A-Za-z.;_0-9]+)\s*(?:\.|\s|;)\s*((?:com|edu))\W')
epatterns.append(r'([A-Za-z._0-9-]+)@([A-Za-z.;_0-9-]+)\.(-e-d-u)')
    ...
    for line in f:
        ...
        for epat in epatterns:
            ...
            for m in matches:
                ...
                #email = '%s@%s.edu' % m
                email = '{}@{}.edu' .format(m[0],m[1]) or '{}@{}.com' .format(m[0],m[1])
